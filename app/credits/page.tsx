...
export default function CreditsPage() {
    return (
        <div className="flex flex-col min-h-screen items-center justify-center bg-game-bg text-game-text p-8 text-center space-y-8">
            ...
            <div className="space-y-2 shrink-0">
                ...
                <p className="text-2xl font-semibold text-game-accent italic">Inti Vidal</p>
            </div>
