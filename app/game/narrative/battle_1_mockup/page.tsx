...
export default function Battle1MockupPage() {
  ...
  useEffect(() => {
    ...
    // Generar ventanas emergentes aleatorias para simular popups invasivos
    const popupList = [
    ...
    // Barra de progreso de descarga maliciosa
    ...
    // Redirigir al nodo de fracaso después de experimentar el caos
