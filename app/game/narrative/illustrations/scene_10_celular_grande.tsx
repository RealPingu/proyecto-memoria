    ...
    <svg viewBox="0 0 500 600" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <g id="productos-grid" transform="translate(110, 90)">
          <text x="0" y="0" fontFamily="sans-serif" fontSize="13" fontWeight="900" fill="#64748b" letterSpacing="1.5">RECOMENDADOS</text>
          ...
          <g id="producto-1" transform="translate(0, 20)">
            ...
            <text x="15" y="120" fontFamily="sans-serif" fontSize="12" fontWeight="bold" fill="#0f172a">$19.99</text>
          </g>
          ...
          <g id="producto-2" transform="translate(145, 20)">
            ...
            <rect x="15" y="95" width="105" height="8" rx="2" fill="#cbd5e1"/>
            <text x="15" y="120" fontFamily="sans-serif" fontSize="12" fontWeight="bold" fill="#0f172a">$299.99</text>
          </g>
          ...
          <g id="producto-3" transform="translate(0, 175)">
            ...
            <rect x="15" y="95" width="105" height="8" rx="2" fill="#cbd5e1"/>
            <text x="15" y="120" fontFamily="sans-serif" fontSize="12" fontWeight="bold" fill="#0f172a">$4.99</text>
          </g>
          ...
          <g id="producto-4" transform="translate(145, 175)">
            ...
            <rect x="15" y="95" width="105" height="8" rx="2" fill="#cbd5e1"/>
            <g transform="translate(112, 10)" id="prod-badge-select">
            ...
            <text x="15" y="120" fontFamily="sans-serif" fontSize="12" fontWeight="bold" fill="#22c55e">$49.99</text>
          </g>
        </g>
        ...
        <g id="checkout-footer" transform="translate(92, 420)">
          ...
          <text x="24" y="27" fontFamily="sans-serif" fontSize="12" fontWeight="bold" fill="#64748b">TOTAL PINGÜICARRO</text>
          <text x="292" y="30" fontFamily="sans-serif" fontSize="22" fontWeight="900" fill="#0f172a" text-anchor="end">$49.99</text>
          ...
          <g id="boton-compra-grupo" transform="translate(20, 50)">
            ...
            >
              ...
              <text x="136" y="31" fontFamily="sans-serif" fontSize="15" fontWeight="900" fill="#ffffff" text-anchor="middle" letterSpacing="1.2">
                ALETEA PARA PAGAR
              </text>
            </motion.g>
          </g>
      ...
      {/* CAMO PINGÜINO PEAKING */}
      <g id="camo-peaking" transform="translate(-10, 430)">
        <ellipse id="cuerpo" cx="30" cy="120" rx="55" ry="65" fill="url(#camo-digital)" stroke="#4f5d4e" strokeWidth="0.8" transform="rotate(-15, 30, 120)" />
        <ellipse id="vientre" cx="48" cy="120" rx="34" ry="48" fill="#d8d8d0" stroke="#1e293b" strokeWidth="1" transform="rotate(-15, 48, 120)" />
        <circle id="cabeza" cx="62" cy="55" r="34" fill="url(#camo-digital)" stroke="#4f5d4e" strokeWidth="0.8" />
        
        {/* Ojo asombrado hipnotizado (SIN Zzzs) */}
        <g id="ojo-grupo">
        ...
        <path id="ceja" d="M 60,33 Q 74,35 80,41" stroke="#1c1917" strokeWidth="2.2" fill="none" strokeLinecap="round" />
        <polygon id="pico" points="91,48 114,53 93,62" fill="#f59e0b" stroke="#d97706" strokeWidth="0.8" />
        
        {/* Aleta que tiembla y apunta al botón */}
        <motion.path 
          id="aleta" 
