  ...
  return (
    <svg viewBox="0 0 200 120" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <pattern id="teselacion-enemigo-20" width="40" height="40" patternUnits="userSpaceOnUse" patternTransform="matrix(0.999888, 0.017041, -0.013154, 0.999888, 3.179298, -3.381333)">
      ...
      {/* Fondo de batalla */}
      <rect width="200" height="120" fill="url(#grad-fondo-batalla-20)" id="rect-fondo"/>
      ...
      >
        <g id="patron-oscuro-figura" transform="matrix(0.204386, 0, 0, 0.179566, 109.414691, 19.192984)">
          ...
          <polygon id="patron-rombo-cuerpo" points="128.429 358.794 101.59 118.309 301.567 121.718 268.414 361.179" fill="url(#teselacion-enemigo-20)" stroke="#06b6d4" strokeWidth="2.5" style={{ transformOrigin: '200px 240px' }}/>
