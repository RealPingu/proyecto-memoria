          ...
          >
            ...
            {camoVariantId === 2 && (
              <g id="alma-ojos-v2">
                ...
                <path d="M 92 27.5 H 95.5" stroke="#e2e8f0" strokeWidth="0.8" strokeLinecap="round" id="ojo-der-v2" />
              </g>
            )}
            {camoVariantId === 3 && (
              <g id="alma-ojos-v3">
                <path d="M 85 28.5 L 87.5 26.5" stroke="#e2e8f0" strokeWidth="0.95" strokeLinecap="round" id="ojo-izq-v3" />
                <path d="M 92 26.5 L 94.5 28.5" stroke="#e2e8f0" strokeWidth="0.95" strokeLinecap="round" id="ojo-der-v3" />
              </g>
            )}
            {camoVariantId === 4 && (
              <g id="alma-ojos-v4">
                <path d="M 84.5 27.5 H 88" stroke="#ffffff" strokeWidth="0.65" strokeLinecap="round" id="ojo-izq-v4" />
                <path d="M 92 27.5 H 95.5" stroke="#ffffff" strokeWidth="0.65" strokeLinecap="round" id="ojo-der-v4" />
              </g>
            )}
            {camoVariantId === 6 && (
              <g id="alma-ojos-v6">
            ...
            {camoVariantId === 7 && (
              <g id="alma-ojos-v7">
                ...
                <path d="M 92 28 C 92.5 26.5 94.5 26.5 95 28" stroke="#cbd5e1" fill="none" strokeWidth="0.75" strokeLinecap="round" id="ojo-der-v7" />
              </g>
            )}
            {camoVariantId === 8 && (
              <g id="alma-ojos-v8">
                ...
                <path d="M 94 25.5 L 95 27.5 L 97 27.5 L 95 28.5 L 94 30.5 L 93 28.5 L 91 27.5 L 93 27.5 Z" fill="#fef08a" stroke="#fbbf24" strokeWidth="0.4" id="ojo-der-v8" />
              </g>
            )}
          </motion.g>
        </motion.g>

        {/* Partículas flotantes alrededor de la gota */}
