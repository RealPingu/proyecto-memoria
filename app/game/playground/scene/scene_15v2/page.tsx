...
export default function Scene15v2PlaygroundPage() {
  ...
  const handleConfirmPayment = () => {
    ...
    if (checkedSeguro || checkedDonacion || checkedTarifa) {
      router.push('/game/playground/scene/scene_15v2/resultado_2');
    } else {
      router.push('/game/playground/scene/scene_15v2/resultado_1');
    }
  };
  ...
  return (
    <div className="flex flex-col h-screen w-full bg-game-bg text-game-text p-4 md:p-6 overflow-hidden items-center justify-center font-sans relative">
      ...
      {/* Contenedor principal con el Layout Sándwich */}
      <div className="flex flex-col h-full max-w-lg w-full mx-auto justify-between py-2 md:py-4 relative z-10">
        ...
        <main className="flex-1 flex flex-col min-h-0 justify-between py-3 space-y-4 overflow-hidden">
          ...
          {/* Ilustración Fija (Renderizado del sillón táctico) */}
              ...
              {step === 3 && (
                <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-[#22c55e] hover:bg-green-500 text-black font-black py-2.5 rounded text-[10px] uppercase tracking-wider shadow-[2px_2px_0px_rgba(0,0,0,1)] active:translate-x-[0.5px] active:translate-y-[0.5px] active:shadow-none transition-all text-center cursor-pointer"
                  >
                    Confirmar Pago
                  </button>
                </div>
