...
export default function Scene15v2Resultado1Page() {
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-zinc-900 pb-4 mb-6 shrink-0 gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
              Opción 1 — Éxito de la Compra
            </p>
            <p className="text-xs text-zinc-500">
              Camo revisó minuciosamente cada paso y desactivó las opciones trampa.
            </p>
          </div>
            ...
            <div className="space-y-4 flex-1 flex flex-col justify-center">
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-xl border border-emerald-500/25 bg-emerald-950/10 text-emerald-100 leading-relaxed text-sm">
                  Pasas atentamente por cada paso del asistente. Te das cuenta de que el seguro de bombas atómicas es totalmente innecesario y que tendrías que pagar una pingüinada cada mes. Camo decide optar por salir del seguro y de la donación falsa, completando la reserva al precio correcto.
                </div>
              </div>

              <div className="p-4 rounded-xl border border-emerald-500/30 bg-emerald-550/10 text-center">
                <p className="text-sm font-bold text-emerald-400">
                  ¡Felicidades! Has evitado el Drip Pricing (Precios por Goteo) con éxito.
                </p>
              </div>
            </div>
