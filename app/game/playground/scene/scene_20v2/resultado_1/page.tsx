...
export default function Scene20v2Resultado1Page() {
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-zinc-900 pb-4 mb-6 shrink-0 gap-4">
          <div className="space-y-1">
            ...
            <p className="text-xl font-bold tracking-tight text-white flex items-center gap-2">
              Opción 1 — Análisis de Coste Real
            </p>
            <p className="text-xs text-zinc-500">
              Camo analizó con cuidado la letra pequeña y esquivó el anclaje visual.
            </p>
          </div>
          <div className="flex gap-2">
            <button
              onClick={() => router.push('/game/playground/scene/scene_20v2')}
          ...
          <div className="lg:col-span-7 bg-zinc-950/50 border border-zinc-900 rounded-lg p-6 flex flex-col justify-between backdrop-blur-sm shadow-xl">
            ...
            <div className="space-y-4 flex-1 flex flex-col justify-center">
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-xl border border-emerald-500/25 bg-emerald-950/10 text-emerald-100 leading-relaxed text-sm">
                  Camo analiza minuciosamente los plazos reales y la tasa TEA. Se da cuenta de que el Plan Premium, a pesar de anunciar un 3.5% TNA, lo atará por 20 años pagando casi tres veces el costo original del iglú. Decide elegir el Plan Estándar de 36 meses, evadiendo con éxito la trampa de anclaje de precios de referencia.
                </div>
              </div>

              <div className="p-4 rounded-xl border border-emerald-500/30 bg-emerald-550/10 text-center">
                <p className="text-sm font-bold text-emerald-400">
                  ¡Felicidades! Has evitado el Reference Pricing (Precios de Referencia) con éxito.
                </p>
              </div>
            </div>
            ...
            <div className="border-t border-zinc-900 pt-3 mt-4 flex justify-end gap-3">
              <button
                ...
                className="px-5 py-2.5 text-xs font-bold rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white shadow-lg active:scale-95 transition"
              >
                Volver al Menú
              </button>
            </div>
