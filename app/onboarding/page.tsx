  ...
  return (
    <div className="flex flex-col h-screen w-full bg-game-bg text-game-text p-6 md:p-12 overflow-hidden">
      <div className="flex flex-col h-full max-w-2xl w-full mx-auto space-y-6">
        ...
        {/* Sección de reglas elástica con scroll interno */}
        ...
        {/* Pie de página fijo con consentimiento y botones */}
        <div className="space-y-6 shrink-0 pb-2">
          ...
          <div className="flex flex-col w-full max-w-xs mx-auto space-y-3">
            <button 
              onClick={handleStart}
              className="h-14 w-full bg-game-accent text-game-bg font-bold uppercase tracking-widest transition-all hover:bg-game-text active:scale-95"
            >
              Entrar al juego
            </button>
            ...
            <button 
              onClick={() => router.push('/')}
              className="h-14 w-full border border-zinc-700 text-game-muted font-bold uppercase tracking-widest transition-all hover:bg-game-surface hover:text-game-accent active:scale-95"
            >
              Volver al menú
            </button>
          </div>
